...
addLayer("hexzd", {
    ...
    update() {
     ...
     if (hasMilestone("ct", 1)) player.hexzd.inflation = player.hexzd.inflation.add(infgain.div(30))
    },
    gainExp()
    {
    ...
    12: {
        ...
        effect() {let lol = player[this.layer].points.add(1).log10().times(new Decimal (10).log10().div(new Decimal (3).log10())).add(1.5)
